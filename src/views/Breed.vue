    ...
    <b-container fluid>
        ...
        <b-row>
            <b-col cols="1" v-for="(favorite, index) in favorites" :key="index">
                <img :src="favorite" alt="Favorite image" style="width: 50px;height: 50px;" />
            </b-col>
        </b-row>
        <b-row>
            <FavoriteDogCard v-for="breed in result" :key="breed.id" :img="breed.url" @get-favorite="setFavorite"/>
        </b-row>
...
import FavoriteDogCard from '@/components/FavoriteDogCard.vue';
